...
import dev.stay.util.misc.CollectionUtil;
import dev.stay.util.word.ItemUtil;
...
public class InventoryUtil
    ...
    public static int findHotbarItem(Item item, Item... optional) {
        List<Predicate<ItemStack>> optionalPredicates = CollectionUtil.convert(optional, o -> s -> ItemUtil.areSame(s, o));
