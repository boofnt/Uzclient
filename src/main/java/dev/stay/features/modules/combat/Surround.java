...
public class Surround extends Module {
    ...
    public void onEnable() {
        ...
        if (((Boolean)this.center.getValue()).booleanValue())
            Stay.positionManager.setPositionPacket(this.startPos.getX() + 0.5D, this.startPos.getY(), this.startPos.getZ() + 0.5D, true, true, true);
        this.retries.clear();
        ...
        for (Vec3d vec3d : vec3ds) {
            ...
            switch (BlockUtil.isPositionPlaceable(position, false)) {
                case 1:
                    ...
                    if (Stay.speedManager.getSpeedKpH() != 0.0D || isExtending || this.extenders >= 1)
                        break;
